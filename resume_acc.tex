...
\title{Resume Computer Engineer}                               % optional, remove / comment the line if not wanted
\address{\#26-D, New Kitchlu Nagar, Hambran Road, Ludhiana, Punjab - 141001}{}{}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\small{Computer Science Engineer with +3 years of experience in Guru Nanak Dev Engineering College, Ludhiana. An innovative thinker, initiative taker and multi dimensional professional with exceptional logical and analytical skills in computer-based software. Looking for an opportunity in the field of information technology as computer programmer in a renowned organization.}
...
\item{\cventry{2014--2018}{Guru Nanak Dev Engineering College}{Bachelor's Degree in Computer Science and Engineering}{81.96\%}{\textit{Punjab, India}}{}}
...
\item Leader in TAP B-Plan Competition for Start-ups held in 2016, Chandigarh.

\vspace{6pt}

\item Won 3rd Prize in "C for Coders" Event held in College.
